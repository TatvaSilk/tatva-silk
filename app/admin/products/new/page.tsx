...
export default function NewProductPage() {
  const [form, setForm] = useState({
    ...
    stock: '',
    category: '',
    image_url: '',        // <-- important: image URL for product_images table
    description: ''
  });
  ...
  async function save() {
    ...
    try {
      ...
      const payload = {
        ...
        image_url: form.image_url.trim() || null,   // <-- this is read by the API to insert into product_images
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      ...
      <div style={{ display: 'grid', gap: 10 }}>
        ...
        <input
          style={input}
          placeholder="Image URL (optional) — this becomes the primary image"
